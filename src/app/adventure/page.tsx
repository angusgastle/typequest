  ...
  return (
    <div className="grid place-items-center py-16 text-center">
      ...
      <p className="mt-3 max-w-md font-display text-lg text-ink/60">
        Hi {session?.name}! Each adventure is a fresh, AI-generated story.
        Type it out before the timer runs out to earn stars and level up!
      </p>
    ...
    <>
      ...
      >
        ...
        <div className="mt-6 grid grid-cols-2 gap-3">
          <Stat label="⭐ Score" value={`+${result.score}`} color="bg-sunny/40" />
          <Stat label="⌨️ Speed" value={`${result.wpm} WPM`} color="bg-teal/30" />
          <Stat
            label="🎯 Accuracy"
