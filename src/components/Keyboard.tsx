            ...
            {ROWS.map((row, i) => (
              ...
              >
                {row.map((key) => {
                  ...
                  const highlight =
                    activeFinger && key.finger === activeFinger;
                  return (
                    <motion.div
                      key={key.code}
                      animate={
                      ...
                      style={{
                        ...
                        color: highlight && !isNext ? FINGER_COLORS[key.finger] : undefined,
                      }}
                    >
  ...
  return (
    <div className="relative mx-auto mb-[-12px] w-full max-w-3xl px-4">
      ...
      >
        ...
        >
          <ellipse cx="80" cy="70" rx="100" ry="40" fill="url(#handL)" opacity="0.25" />
          <path
        ...
        >
          <ellipse cx="80" cy="70" rx="100" ry="40" fill="url(#handR)" opacity="0.25" />
          <path
            d="M0,80 Q0,40 40,40 L120,40 Q160,40 160,80 L160,110 L0,110 Z"
            fill="url(#handR)"
            opacity="0.45"
...
function FingerPip({ cx, cy, active }: { cx: number; cy: number; active: boolean }) {
  return (
    <motion.circle
      cx={cx}
      cy={cy}
