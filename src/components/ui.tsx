...
const variants = {
	...
	sun: "bg-sunny text-ink shadow-[0_6px_0_#e0a800] hover:bg-[#ffe066] border-b-4 border-[#e0a800]",
	ghost: "bg-white/70 text-ink hover:bg-white border-b-4 border-black/10",
};
